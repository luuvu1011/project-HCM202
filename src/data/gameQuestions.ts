...
export const GAME_QUESTIONS: GameQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: '1911–1913', isCorrect: false, explanation: 'Đây là thời kỳ anh ở Marseille và đi tàu sang các nước.' },
      { id: 'b', text: '1913–1917', isCorrect: true,  explanation: 'Đúng! Cuối năm 1913, Nguyễn Tất Thành đến Anh; sống và làm việc tại London đến năm 1917 — trùng thời kỳ Chiến tranh thế giới thứ nhất.' },
      { id: 'c', text: '1919–1923', isCorrect: false, explanation: 'Đây là thời kỳ anh hoạt động tại Paris (Yêu sách Versailles, Tours, Le Paria).' },
      { id: 'd', text: '1924–1927', isCorrect: false, explanation: 'Thời kỳ này anh ở Liên Xô (1923–1924) và Quảng Châu (1924–1927).' },
    ],
    timeLimit: 20,
    points: 100,
  },
